...
Read Me
This folder stores data and analysis codes related to the paper "A Neural Basis of Rational Inattention Models: Consistency of Cognitive Cost with the Mutual Information Criterion". All the results of the study and observed data are contained in the following Matlab struct and codes.
